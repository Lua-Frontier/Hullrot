...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCCVars.TTSVolumeRadio, TTSVolumeRadioSlider.Value / 100f); // Corvax-TTS
        ...
        private void Reset()
        {
            ...
            TTSVolumeRadioSlider.Value = _cfg.GetCVar(CCCVars.TTSVolumeRadio) * 100f; // Corvax-TTS
        ...
        private void UpdateChanges()
        {
            ...
            // Corvax-TTS-Start
            var isTTSVolumeSame =
                Math.Abs(TTSVolumeSlider.Value - _cfg.GetCVar(CCCVars.TTSVolume) * 100f) < 0.01f;
            var isTTSVolumeRadioSame =
                Math.Abs(TTSVolumeRadioSlider.Value - _cfg.GetCVar(CCCVars.TTSVolumeRadio) * 100f) < 0.01f;
            // Corvax-TTS-End
            ...
            var isEverythingSame = isMasterVolumeSame && isMidiVolumeSame && isAmbientVolumeSame && isCombatMusicVolumeSame
                ...
                && isTTSVolumeSame && isTTSVolumeRadioSame; // Corvax-TTS
            ...
            TTSVolumeRadioLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", TTSVolumeRadioSlider.Value / 100));
            // Corvax-TTS-End
        }
    }
}
